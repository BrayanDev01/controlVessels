...
import { MockTypeImpacts } from '../mocks/typeImpacts.js';
import { MockLocations } from '../mocks/locationsMocks.js';
import { MockTypeEquipaments } from '../mocks/typeEquipaments.js';
...
export default{
    ...
    created(){
        ...
        MockTypeImpacts.getImpacts().then((data) => {this.impactOptions = data})
        MockLocations.getLocations().then((data) =>{ this.equipamentOptions = data })
        MockTypeEquipaments.getTypes().then((data) =>{ this.equipamentTypeOptions = data })
    }
}
</script>
<template>
